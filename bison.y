...
%token T_int   fun_main  fbs fbe sbs sbe sem_col com equ_oprtr  plus_oprtr mns_oprtr mult_oprtr div_oprtr  g_oprtr l_oprtr ge_oprtr le_oprtr con_if  con_else  con_elseif  lp_for inc lp_lim con_swi con_swi_def  con_swi_col  equequ_oprtr
%nonassoc IFX
%nonassoc con_else
%left SH
